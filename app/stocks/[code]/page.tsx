  ...
  return (
    <AppShell>
      <div className="page-wrap">
        ...
        <section className="detail-grid"><div className="market-card chart-card"><div className="card-title-row"><div><span className="eyebrow">PRICE ACTION</span><h2>行情结构</h2></div></div><StockChart code={stock.code} price={stock.price} high52={stock.high52} low52={stock.low52} /></div>
