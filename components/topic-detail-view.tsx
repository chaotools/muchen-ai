  ...
  return (
    <>
      ...
      <section className="topic-detail-kpis">
        ...
        <div><span>{isSample ? "样本涨停" : "涨停数量"}</span><strong>{topic.limitUpCount}<small> 家</small></strong><small>{isSample ? `近 30 日样本 ${topic.limitUp30Count} 家` : `近 30 日 ${topic.limitUp30Count} 家`}</small></div>
